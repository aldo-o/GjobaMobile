...
namespace gjobaMobile
{
    ...
    /// </summary>
    public sealed partial class shfaqMakinat : Page
    {
        ...
        private void listBoxobj_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                makinat listitem = listBoxobj.SelectedItem as makinat;//Get slected listbox item contact ID  
                Frame.Navigate(typeof(makinaDetail), SelectedContactID = listitem.Id);
