...
namespace gjobaMobile
{
    ...
    public sealed partial class App : Application
    {
        ...
        public static string DB_PATH = Path.Combine(Path.Combine(ApplicationData.Current.LocalFolder.Path, "gjobaM.sqlite"));
        /// <summary>
        ...
        public App()
        {
            ...
            if (!CheckFileExists("gjobaM.sqlite").Result)
            {
                using (var db = new SQLiteConnection(DB_PATH))
                {
                    db.CreateTable<makinat>();
                }
            }
        }
